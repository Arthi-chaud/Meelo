...
export const LightMode: Icon = (props: IconProps) => {
	const Icon_ = Iconsax.Sun1 as any;
	return <Icon_ variant="Bold" {...props} />;
};
...
export const InfoIcon: Icon = (props) => {
	const Icon_ = Iconsax.InfoCircle as any;
	return <Icon_ style={{ rotate: "180deg" }} {...props} />;
};
...
export const ContextualMenuIcon: Icon = (props) => {
	const Icon_ = Iconsax.More as any;
	return <Icon_ {...props} style={{ rotate: "90deg" }} size={18} />;
};
